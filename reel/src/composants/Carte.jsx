...
export const Carte = ({ x, y, w, numero, label, sous, delai = 0, fin = 1e9 }) => {
  ...
  return (
    <div style={{ position: 'absolute', left: x, top: y, width: w, boxSizing: 'border-box', padding: '20px 24px',
      ...
      opacity: Math.min(interpolate(s, [0, 1], [0, 1]), interpolate(frame, [fin, fin + 10], [1, 0], { extrapolateLeft: 'clamp', extrapolateRight: 'clamp' })),

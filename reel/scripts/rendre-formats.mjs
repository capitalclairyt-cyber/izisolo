...
const COMPOSITIONS = { split: 'Split', 'reponse-dm': 'ReponseDM', rentree: 'Rentree', migration: 'Migration', freemium: 'Freemium', avis: 'Avis', ...Object.fromEntries(SCENES.map((s) => [`fonction-${s}`, `Fonction-${s}`])) };

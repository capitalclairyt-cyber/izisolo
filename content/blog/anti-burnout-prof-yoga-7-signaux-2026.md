---
title: "Burnout du prof de yoga : 7 signaux à surveiller"
...
faq:
  - question: "Combien de profs de yoga abandonnent à cause du burnout ?"
    answer: "Selon les retours croisés de la communauté des profs solo français (enquêtes informelles, témoignages communautaires), environ 40 % des profs de yoga indépendant·e·s abandonnent leur activité dans les 5 ans qui suivent leur installation. La principale cause n'est pas le manque d'élèves ou de talent, mais l'épuisement progressif — admin éparpillé, dispersion énergétique entre 15+ cours hebdo, manque de pratique personnelle dédiée, isolement professionnel."
  - question: "Quels sont les signaux d'un burnout chez un·e prof de yoga ?"
    answer: "Les 7 signaux principaux : (1) tu redoutes ton cours préféré du moment ; (2) tu pleures sans raison après les séances ; (3) tu prends moins soin de ton apparence en cours ; (4) tu compares obsessionnellement ton planning à celui d'autres profs ; (5) tu tardes à répondre aux messages d'élèves alors que tu avais l'habitude d'être réactive ; (6) tu te répètes 'c'est pas pour moi' sans pouvoir t'arrêter ; (7) ta pratique personnelle a disparu depuis 2-6 mois. La présence de 3+ signaux sur ces 7 est un signal d'alarme à ne pas ignorer."
  - question: "Comment se remettre d'un burnout en tant que prof de yoga ?"
    answer: "Trois leviers prioritaires : (1) réduire ton nombre de cours hebdo de 30-40 % temporairement (de 18 à 12 par exemple), en augmentant les tarifs pour compenser financièrement ; (2) reprendre une pratique personnelle dédiée — 3-4× par semaine, sans enseignement, juste pour toi ; (3) automatiser l'admin (logiciel de gestion intégré qui fait disparaître les 6-8h hebdo de paperasse). Ces 3 leviers combinés sortent typiquement de l'épuisement en 8-12 semaines. Si après 3 mois ça ne s'améliore pas, consulte un·e thérapeute spécialisé·e burnout — il y a probablement une dimension qui dépasse l'ajustement métier."
  - question: "Faut-il prendre une pause complète quand on est prof de yoga épuisée ?"
    answer: "Oui, et c'est même fortement recommandé. Une pause de 2-4 semaines totales (pas de cours, pas d'admin, pas de pratique d'enseignement) est souvent salvatrice. Beaucoup de profs ont peur de la faire car elles craignent de perdre leurs élèves — mais l'expérience montre que 90 % des élèves attendent et reviennent (à condition d'avoir prévenu honnêtement). Une prof solo qui ne prend jamais de vraies vacances dégrade progressivement la qualité de ses cours et finit par perdre plus d'élèves qu'avec une vraie pause."
  - question: "Comment éviter de tomber dans le burnout en tant que prof de yoga ?"
    answer: "Quatre règles préventives : (1) ne dépasse jamais 15-16 cours hebdo sur la durée — c'est physiquement et énergétiquement insoutenable au-delà de 6 mois ; (2) garde une pratique personnelle ferme de 3h/semaine minimum, sans enseignement ; (3) bloque 1 jour complet par semaine OFF (pas de cours, pas d'admin) — sacré, non-négociable ; (4) prévois 2 semaines de vacances par trimestre + 1 mois en été. Si tu ne peux pas, c'est que ton modèle économique est mal calibré (tarifs trop bas, trop de cours pour boucler les fins de mois) et il faut corriger ça en priorité."
---
...
<figure class="article-figure">
  <img src="/icons/hero-cocoon.png" alt="Espace de pratique zen avec un cocon doux, ambiance restauratrice" loading="lazy" />
  <figcaption>Le bien-être de la prof n'est pas un luxe. C'est la condition même du métier.</figcaption>
</figure>
...
6-8 heures hebdo perdues à synchroniser Excel + Calendly + WhatsApp + Stripe + agenda papier. Cf. notre [article comparatif Excel vs logiciel](/blog/excel-vs-logiciel-gestion-eleves-prof-yoga). C'est une **fuite énergétique invisible** mais constante.
...
Tu **dois** assurer X cours pour boucler les fins de mois. Tu ne peux pas refuser un cours. Tu ne peux pas prendre 2 semaines off. Tu vis dans la peur de la fragilité financière. Cf. notre [article sur les tarifs](/blog/comment-fixer-tarifs-prof-yoga-2026) — souvent le problème est un sous-pricing structurel.
...
<figure class="article-figure">
  <img src="/icons/persona-meditation.jpg" alt="Personne en posture de méditation assise, ambiance contemplative et apaisante" loading="lazy" />
  <figcaption>Reprendre une pratique personnelle dédiée — 3-4× par semaine, sans enseignement — est le levier #1 de récupération.</figcaption>
</figure>
...
Math : 18 cours × 110 €/cours × 4 semaines = 7 920 €
Versus : 12 cours × 140 €/cours × 4 semaines = 6 720 €
...
Bascule sur un logiciel de gestion intégré qui te fait passer de 6-8h hebdo d'admin à 30-45 min. Cf. notre [guide pour choisir](/blog/comment-choisir-logiciel-gestion-studio-yoga-2026).
...
Reviens à ton angle (cf. notre [article sur la marque personnelle](/blog/construire-marque-personnelle-prof-yoga-2026)). Tu as peut-être besoin de **changer**, pas juste de te reposer.

## La méthode "audit énergie" — 4 questions mensuelles

Tous les 1ᵉʳ du mois, prends 15 minutes pour répondre honnêtement :

1. **De 1 à 10, quelle est mon énergie globale ce mois-ci ?** (moyenne sur le mois écoulé)
2. **Quel cours m'a le plus rechargée ?** Quel cours m'a le plus vidée ?
3. **Combien d'heures j'ai pratiqué pour moi cette semaine ?** (sans enseignement)
4. **Si je devais prendre 2 semaines off demain, qu'est-ce qui s'effondrerait vraiment ?**
...
*Pour aller plus loin : lis aussi [comment fixer tes tarifs sans te brader](/blog/comment-fixer-tarifs-prof-yoga-2026) pour résoudre la cause #4 (dépendance financière), et [comment choisir ton logiciel de gestion](/blog/comment-choisir-logiciel-gestion-studio-yoga-2026) pour résoudre la cause #1 (admin éparpillé). Ces 2 changements à eux seuls font sortir 60 % des profs solo de la zone burnout.*

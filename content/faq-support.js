...
export const FAQ_SUPPORT = [
  ...
  },
  {
    ...
    a: "Oui. Paramètres → Ma page publique → « Ce que ta page montre » → « Langue de ma page et de l'espace de mes élèves » : Automatique (chaque visiteuse voit ta page dans la langue de son téléphone ou de son navigateur, français ou anglais ; c'est le réglage de départ), Français ou English (tout le monde arrive dans cette langue), enregistré tout de suite. En anglais, ta page publique, la réservation, la connexion, l'espace élève et les emails de confirmation de réservation et de lien de connexion parlent anglais. Tes textes à toi (bio, noms de cours, FAQ, noms d'offres) restent tels que tu les as écrits : l'app ne traduit jamais ce que tu as saisi. Quel que soit ton réglage, chaque visiteuse garde un bouton FR / EN en haut de ta page pour choisir sa langue, et ce choix tient sur son appareil. Dès qu'une élève connectée choisit sa langue (ou réserve avec), sa fiche s'en souvient : ses emails et ses notifications (rappel de séance, annulation, liste d'attente, essai, facture, message de ta part) partent ensuite dans cette langue, même quand c'est toi ou l'app qui les envoie. Une élève qui n'a rien choisi suit ton réglage. Et une langue que l'app a seulement devinée d'après son navigateur (réglage Automatique) s'efface dès que tu choisis Français ou English : ton choix reprend la main, seule une langue choisie par l'élève avec le bouton FR / EN reste la sienne. Un point à connaître : une élève qui ouvre « Mon espace » avant d'avoir réservé arrive sur un écran qui lui propose directement tes prochaines séances avec un bouton Réserver, dans sa langue, pour qu'elle ne s'arrête pas à la connexion en croyant avoir fini.",
    lien: { href: '/aide#page-publique', label: 'Voir le pas-à-pas' },
  },
  {
    // La fenêtre de la page publique (2026-09-23, Manon / Soleya : ses élèves
    // lisaient « Aucun cours cette semaine » sur une semaine de novembre bien
    // remplie). AJOUTÉE EN FIN.
    q: "Je vois mes séances de novembre dans mon agenda, mais mes élèves ne voient rien au-delà de deux mois ?",

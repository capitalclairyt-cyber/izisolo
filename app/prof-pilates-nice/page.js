...
export const metadata = {
  ...
  description: "Outil de gestion pensé pour les profs de Pilates indépendant·e·s à Nice : Mat + Reformer, planning, élèves, paiements, portail public. Gratuit pour commencer, sans carte bancaire.",

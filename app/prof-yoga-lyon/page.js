...
export const metadata = {
  ...
  description: "Outil de gestion pensé pour les profs de yoga indépendant·e·s à Lyon : agenda, élèves, paiements, portail public. Gratuit pour commencer, sans carte bancaire.",

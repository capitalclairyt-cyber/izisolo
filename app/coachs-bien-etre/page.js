...
export const metadata = {
  ...
  description: "Sessions 1-à-1, programmes, suivi sur la durée. IziSolo réunit tes RDV, tes notes confidentielles et tes paiements. Gratuit pour commencer, sans carte bancaire.",
  ...
  openGraph: {
    ...
    url: 'https://www.izisolo.fr/coachs-bien-etre',
    type: 'website',

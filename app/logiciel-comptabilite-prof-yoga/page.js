...
export const metadata = {
  ...
  description:
    "Livre des recettes, factures numérotées avec ton SIRET et montant de ta déclaration URSSAF calculé à la date d'encaissement. Tout ce que la micro-entreprise réclame, gratuit pour commencer, sans carte bancaire.",
  keywords: [

...
const SECTIONS = [
  ...
  },
  {
    ...
    etapes: [
      ...
      <>Des élèves anglophones ? Dans <strong>« Ce que ta page montre »</strong>, choisis la <strong>langue</strong> de ta page et de l&apos;espace de tes élèves : <strong>Automatique</strong> (chaque visiteuse voit ta page dans la langue de son téléphone ou de son navigateur, c&apos;est le réglage de départ), Français ou English. En anglais, la page, la réservation, la connexion, l&apos;espace élève et tous les emails et notifications d&apos;une élève parlent anglais (confirmation, rappel de séance, annulation, liste d&apos;attente, essai, facture, tes messages) ; tes textes à toi (bio, noms de cours, FAQ, messages) restent tels que tu les as écrits. Quel que soit ton choix, chaque visiteuse garde un bouton <strong>FR / EN</strong> en haut de ta page pour choisir la sienne, et sa fiche s&apos;en souvient pour ses emails.</>,

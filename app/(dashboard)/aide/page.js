...
const SECTIONS = [
  {
    ...
    etapes: [
      ...
      <>Renseigne le nom, l'heure, la durée, le lieu et la capacité. Sous la <strong>date</strong>, IziSolo écrit le jour de la semaine en toutes lettres (« Mardi 1 septembre 2026 ») : c'est ton garde-fou si l'année part de travers en tapant au clavier, parce que le petit calendrier qui s'ouvre au clic est celui de ton navigateur et n'affiche jamais le jour. Le <strong>type de cours</strong> (Hatha, Vinyasa…) est optionnel mais utile si tes carnets ne valent que pour certains cours.</>,
  ...
  },
  {
    ...
    etapes: [
      ...
      <>Pour changer l'horaire, le lieu, le nom ou le <strong>nombre de places</strong> de <strong>toutes</strong> les séances à venir : bouton <strong>« Modifier toute la série »</strong> sur la page de la séance. Le champ <strong>« Places max (toute la série) »</strong> s'applique aux séances à venir et aux séances que tu ajouteras plus tard en rallongeant la série ; le crayon d'une séance, lui, ne change que cette séance. Si une séance a déjà plus d'inscrites que le nouveau nombre, l'aperçu te le dit avant de confirmer : personne n'est retiré, elle reste simplement complète.</>,
      ...
      <>Changement de programme, la séance a finalement lieu ? Sur sa page, <strong>« Rétablir cette séance »</strong> : elle redevient normale, dans sa série, sans doublon, et les élèves encore inscrit·es reçoivent un email « séance maintenue » (les carnets ne bougent pas, le pointage fera le décompte). Le même bouton <strong>↺</strong> existe sur la case rouge du calendrier de la série, dans Cours récurrents. Une séance passée ne se rétablit pas : recrée-la si c'est du rattrapage.</>,
      <>Tu veux la faire disparaître complètement ? Après l'annulation, la <strong>corbeille</strong> la supprime. Ne recrée jamais une séance annulée à la main : tu obtiendrais une séance orpheline, hors série, à côté de l'annulée. Rétablis-la.</>,
  ...
  },
  {
    ...
    etapes: [
      ...
      <>Ta liste n'existe que <strong>sur papier</strong> ? Sur ce même écran, <strong>« Lire une photo de liste »</strong> : photographie-la bien à plat, une page à la fois, et chaque personne devient une ligne. Tu arrives sur le même écran de vérification, avec <strong>toutes</strong> les lignes affichées : relis-les, une photo se lit bien mais ne se devine pas. Ce qui est illisible reste vide plutôt que d'être inventé, et rien n'est enregistré avant que tu valides. Pour un fichier venu d'un tableur, garde le CSV : c'est plus fidèle.</>,
      ...
      <>Sur ta liste, une <strong>pastille</strong> dit où chacune en est : <strong>« Connecté·e »</strong> (déjà venue chez toi, avec la date de sa dernière visite), <strong>« Invité·e »</strong> (le lien est parti, elle ne s'en est pas encore servie), <strong>« Jamais connecté·e ici »</strong> et <strong>« Pas de compte »</strong>. Ces pastilles parlent de <em>ton</em> espace, jamais de ce qu'une élève fait ailleurs.</>,
      <>Un compte élève est commun à tout IziSolo : une adresse email, un compte. Une nouvelle adhérente peut donc arriver chez toi avec le sien, parce qu'elle prend aussi des cours ailleurs. Elle apparaît alors <strong>« Jamais connecté·e ici »</strong> : <strong>invite-la comme les autres</strong>, son compte lui évitera juste de créer un mot de passe.</>,
    ],
  ...
  },
  {
    ...
    etapes: [
      ...
      <>Tarif à l'unité <em>et</em> carnets sur le même cours ? Coche <strong>« Accepter aussi les carnets/abos compatibles »</strong> : <strong>au pointage</strong>, celles dont le carnet couvre ce type décomptent une séance, les autres paient le tarif. Renseigner le type de cours ne suffit pas : c'est le <a href="#pointage">pointage</a> qui décompte, toujours.</>,
      <>Tes élèves voient <strong>tout ton catalogue</strong> dans leur espace, et ta page publique l'affiche aussi si tu actives ta grille (bannière <strong>« Afficher ma grille sur mon portail »</strong>). Sans paiement en ligne, une élève peut <strong>« Demander »</strong> une offre : la demande atterrit en tête de ta page Offres <em>et</em> sur la <strong>fiche de l'élève</strong> (bandeau « 🛒 Demande d'offre à traiter »), et le bouton <strong>« Voir la demande »</strong> de ta cloche t'y amène. <strong>« Attribuer l'offre »</strong> ouvre la vente directement sur le règlement, « Écarter » la retire, et une vente faite depuis la fiche solde la demande toute seule. Rien n'est encaissé ni réservé tant que tu n'as pas fait la vente. Tu vends ailleurs (sur ton site, par exemple) et tu ne veux pas que l&apos;espace de tes élèves leur propose tes offres ? <strong>Paramètres → Ma page publique → Ma page</strong>, carte « Ce que ta page montre », désactive <strong>« Proposer mes offres dans l&apos;espace de mes élèves »</strong> : la section disparaît, leurs paiements, carnets et factures restent, et tu continues d&apos;attribuer tes offres depuis les fiches.</>,
      <>Une demande peut venir de <strong>quelqu'un que tu ne connais pas encore</strong> : ta page publique est ouverte à tout le monde, et une visiteuse y laisse son prénom et son email. La ligne porte alors le badge <strong>« page publique · pas encore de fiche »</strong> et <strong>son adresse, cliquable</strong> : tu peux lui écrire avant même de décider. Le bouton devient <strong>« Créer la fiche et attribuer »</strong> : il crée l'élève avec ces coordonnées (ou reprend sa fiche si elle existe déjà à cette adresse), puis ouvre la vente sur le règlement.</>,
    ],
  ...
  },
  {
    ...
    etapes: [
      ...
      <>« À régler plus tard » et les versements à venir ne sont pas des oublis : ils t'attendent dans <strong>Revenus → « À percevoir »</strong> et sur la fiche de l'élève, encaissables en un clic (espèces, chèque, virement, CB), chacun à sa date d'encaissement. <strong>L'argent arrive en deux chèques, ou moitié espèces moitié CB ?</strong> Sur la ligne à encaisser, clique <strong>« Encaisser »</strong> puis <strong>« Plusieurs moyens ou plusieurs chèques »</strong> : chaque chèque a sa ligne, son numéro et sa date, et IziSolo refuse un découpage qui ne fait pas le total. Rien à recréer, rien à supprimer : la vente reste la même.</>,
      <>Et l'élève sait quoi faire : à la vente, choisis l'email <strong>« comment régler »</strong> qui part tout seul : <strong>« Virement (RIB) »</strong> (ton IBAN + une référence de virement pour reconnaître son règlement sur ton relevé), « Espèces au studio » ou « Chèque au studio ». Ton RIB et le réglage (« part tout seul », « je choisis à chaque vente », « jamais ») vivent dans <strong>Paramètres → Argent → Virement (RIB)</strong>. Et le bouton « Comment régler ? » de son espace affiche le RIB, la référence et un <strong>QR code</strong> à scanner avec son application bancaire.</>,
      <>Avec le plan Complet, ajoute un <strong>lien de paiement Stripe</strong> à tes offres : tes élèves paient en ligne depuis ton portail, tu n'as plus rien à courir. <strong>Deux gestes, pas un</strong> : coller le lien sur l'offre, ET déclarer le webhook dans <strong>Paramètres → Argent → Paiement en ligne</strong> (l'écran te donne l'URL à copier et où trouver le secret). C'est le webhook qui prévient IziSolo qu'une élève a payé, donc qui crée le paiement et le carnet. Tant qu'il manque, on ne propose pas le paiement à tes élèves : elles voient <strong>« Demander »</strong>, et ta page Offres te dit ce qu'il reste à faire.</>,
      <><strong>Prélèvement automatique</strong> pour un abonnement au mois : dans Stripe, crée un lien de paiement <strong>récurrent</strong> (type « Abonnement », prix « par mois ») et colle-le sur ton offre comme n&apos;importe quel lien. Quand une élève souscrit, sa carte est prélevée chaque mois par Stripe, et IziSolo suit : chaque prélèvement apparaît dans ses paiements, son abonnement se prolonge, et sa facture part toute seule si tu as coché l&apos;envoi automatique. Sur sa fiche, l&apos;abonnement porte le badge <strong>« 💳 Prélèvement auto »</strong> : la pause, le changement de carte et la résiliation se font dans ton Stripe, pas dans IziSolo (sinon la carte continuerait d&apos;être débitée). Si un prélèvement échoue, ta cloche te prévient et l&apos;élève reçoit un email ; après trois échecs, l&apos;abonnement passe en pause tout seul. Pense à cocher les événements <code>invoice.paid</code>, <code>invoice.payment_failed</code> et <code>customer.subscription.deleted</code> sur ton endpoint Stripe (l&apos;écran Paiement en ligne les liste).</>,
    ],
  ...
  },
  {
    ...
    etapes: [
      ...
      <>Un chèque arrive, un virement, un complément : carte du carnet → <strong>« Encaisser un versement »</strong>, mode déclaré, date d'encaissement. Si une ligne <strong>attend déjà</strong> sur cet abonnement (« à encaisser », par exemple les 480 € d'un abonnement vendu « à régler plus tard »), ce versement <strong>s'en déduit</strong> : la modale le dit pendant que tu tapes (« il restera 235 € à encaisser »), la ligne en attente baisse d'autant, et rien n'est compté deux fois. Si tout arrive d'un coup, en un ou plusieurs chèques, le bouton « Encaisser » de la ligne fait la même chose en un geste.</>,
      <>Ta cloche te rappelle ce qui attend depuis trop longtemps (seuil dans <strong>Paramètres → Élèves &amp; cours → Seuils d'alerte</strong>, 14 jours par défaut). Après un premier chèque, le rappel dit <strong>« reste 235 € (245 € déjà reçus, dernier par chèque le 08/09) »</strong> et compte les jours depuis ce chèque, pas depuis la vente. Un rappel lu ne revient pas avant une semaine, et il disparaît dès que tu encaisses le reste. S'il parle d'une élève qui t'a payée, c'est que son règlement n'est pas encore dans IziSolo : fiche → Paiements → « Encaisser » sur la ligne.</>,
  ...
  },
  {
    ...
    etapes: [
      ...
      <><strong>C'est le seul geste qui décompte</strong> : tant qu'une séance n'est pas pointée, les carnets de tes élèves ne bougent pas, même si le type de cours correspond parfaitement. Autrement dit, tu n'as jamais à corriger les cartes à la main sur les fiches : le bouton « Modifier les séances déjà faites » sert au <strong>rattrapage</strong> de ce qui s'est passé avant IziSolo, pas au quotidien.</>,
      <>Quelqu'un débarque sans fiche ? <strong>« Ajouter des élèves »</strong> crée la fiche à la volée, sans quitter le pointage. Ce modal ne propose que les élèves qui ne sont <strong>pas encore</strong> sur la séance : si tu tapes le nom de quelqu'un qui a déjà réservé, il te le dit (« Catherine Mazoyer est déjà sur cette séance (présent·e) »), elle est plus haut dans ta liste de pointage. Et si le cours fait partie d'une série, <strong>« Inscrire sur : »</strong> te laisse choisir la portée : <strong>« Cette séance »</strong>, « Les N prochaines » ou <strong>« Toute la série »</strong>, avec un aperçu qui dit combien d'inscriptions ça crée.</>,
      ...
      <>Les absences suivent <strong>tes</strong> règles (Paramètres → Élèves &amp; cours) : les cas ambigus remontent dans <strong>« À traiter »</strong> et tu tranches. « Excuser » re-crédite la séance.</>,
  ...
  },
  {
    ...
    etapes: [
      ...
      <>Le comportement automatique se règle dans <strong>Paramètres → Élèves &amp; cours</strong> : rubrique <strong>« Annulation »</strong> (ton délai, ta politique) et rubrique <strong>« Cas particuliers »</strong> (les 7 situations, chacune avec ses options).</>,
    ],
  ...
  },
  {
    ...
    etapes: [
      <><strong>Paramètres → Élèves &amp; cours → « Annulation »</strong> : choisis ton <strong>délai libre d'annulation</strong> (6 h, 12 h, 24 h, 48 h, 72 h ; 24 h est notre recommandation) et, si tu veux, un message personnalisé.</>,
  ...
  },
  {
    ...
    etapes: [
      ...
      <>Pour une info collective, bouton <strong>« Annoncer »</strong> : choisis les destinataires parmi <strong>tous tes élèves</strong>, les <strong>inscrit·es d'un cours</strong>, les <strong>habitué·es d'un type</strong>, les <strong>détenteurs d'une offre</strong>, ou une <strong>sélection libre</strong>, avec aperçu de la liste avant envoi.</>,
  ...
  },
  {
    ...
    etapes: [
      ...
      <>Pour des <strong>factures acquittées</strong> (celles qu'exigent CSE, employeurs et mutuelles) : <strong>Paramètres → Argent → Facturation</strong> (ton nom ou ta raison sociale + ton <strong>SIRET</strong>).</>,
  ...
  },
  {
    ...
    etapes: [
      <>Une fois pour toutes, dans <strong>Paramètres → Argent → Déclaration URSSAF</strong> : ton régime, si tu déclares au mois ou au trimestre, et tes taux (recopie-les depuis ton compte autoentrepreneur.urssaf.fr, ils changent d&apos;une année à l&apos;autre).</>,
  ...
  },
  {
    ...
    etapes: [
      ...
      <>Réglages dans <strong>Paramètres → Ma page publique</strong>. « Ma page » se lit en trois cartes : l'essentiel (couverture, photo, bio, réseaux), <strong>« Ce que ta page montre »</strong> (horaires, tarifs, offres dans l'espace élève) et <strong>« Aller plus loin »</strong> (expérience, formations, philosophie, FAQ). À côté : le cours d'essai, et « Intégrer sur mon site » pour tes couleurs et ton QR code.</>,
      ...
      <>Des élèves anglophones ? Dans <strong>« Ce que ta page montre »</strong>, choisis la <strong>langue</strong> de ta page et de l&apos;espace de tes élèves : <strong>Automatique</strong> (chaque visiteuse voit ta page dans la langue de son téléphone ou de son navigateur, c&apos;est le réglage de départ), Français ou English. En anglais, la page, la réservation, la connexion, l&apos;espace élève et tous les emails et notifications d&apos;une élève parlent anglais (confirmation, rappel de séance, annulation, liste d&apos;attente, essai, facture, tes messages) ; tes textes à toi (bio, noms de cours, FAQ, messages) restent tels que tu les as écrits. Quel que soit ton choix, chaque visiteuse garde un bouton <strong>FR / EN</strong> en haut de ta page pour choisir la sienne, et sa fiche s&apos;en souvient pour ses emails. Une langue seulement devinée d&apos;après son navigateur (réglage Automatique) s&apos;efface dès que tu choisis Français ou English.</>,
      <>Tes <strong>avis Google</strong> : carte <strong>« Mes avis Google »</strong> de Ma page. Colle le lien « Demander des avis » de ta fiche Google Business Profile. Dès lors, tes élèves ont un bouton <strong>« Laisser un avis Google »</strong> dans leur espace, ton QR code gagne un modèle <strong>« Avis Google »</strong> (l&apos;affichette « scanne en sortant »), Messagerie → Annoncer te propose un gabarit, et l&apos;interrupteur <strong>« Demander un avis par email après la 3e séance »</strong> envoie un email une seule fois par élève, jamais plus de cinq par jour (Google se méfie des rafales d&apos;avis). Jamais de séance offerte en échange, jamais de tri entre élèves : Google l&apos;interdit, l&apos;app le respecte.</>,
      <>Tu as un site ? Intègre ton <strong>planning</strong> et ta <strong>grille d&apos;offres</strong> directement dessus (un copier-coller chacun) : Paramètres → Ma page publique → « Intégrer sur mon site ». Tes élèves les consultent sans quitter ton site ; au moment de réserver ou de payer, un onglet s&apos;ouvre sur ta page IziSolo (les navigateurs bloquent les connexions et les paiements à l&apos;intérieur d&apos;un site tiers, aucun outil ne fait autrement).</>,
      ...
      <>Ta page charge <strong>deux mois</strong> de planning d&apos;un coup, puis va chercher la suite dès qu&apos;une élève regarde plus loin : la flèche ▶ de la vue semaine et le bouton <strong>« Voir les semaines suivantes »</strong> de la vue liste affichent tes séances jusqu&apos;à <strong>un an</strong> à l&apos;avance (le temps de charger, l&apos;écran dit « Chargement », jamais « Aucun cours »). Programme ta saison entière sans crainte : une séance publique et non annulée est réservable dès qu&apos;elle existe.</>,
  ...
  },
  {
    ...
    etapes: [
      <>Va dans <strong>Paramètres → Ma page publique → « Types de cours »</strong>. Tu y retrouves tes types (Hatha, Pilates, Atelier…), un par ligne.</>,
  ...
  },
  {
    ...
    etapes: [
      <>Réglages : <strong>Paramètres → Ma page publique → « Cours d'essai »</strong>. Active-le, puis choisis le <strong>mode de validation</strong> : <strong>Automatique</strong> (validée immédiatement), <strong>Semi-automatique</strong> (validée + tu es notifiée), ou <strong>Manuel</strong> (tu valides ou refuses chaque demande depuis l'app).</>,
      ...
      <>En mode manuel, les demandes t'attendent dans <strong>« Cours d'essai »</strong> (nav, avec la pastille) : accepter ou refuser en un clic. Tu n'as pas eu le temps avant le cours et elle est venue quand même ? <strong>Valider après la séance reste possible</strong> : sa fiche est créée, elle est inscrite sur la séance passée (à pointer ensuite), et aucun email de confirmation ne part.</>,
  ...
  },
  {
    ...
    etapes: [
      ...
      <>Tu préfères garder la main ? Passe la règle « Liste d'attente » en mode <strong>manuel</strong> (Paramètres → Élèves &amp; cours → Cas particuliers) : la promotion attend ton clic.</>,
  ...
  },
  {
    ...
    etapes: [
      ...
      <>Elle n'a pas de compte et n'en veut pas ? Sur sa ligne, <strong>« Créer son lien (sans compte) »</strong> fabrique un <strong>lien permanent</strong> : elle l'ouvre sur son téléphone et voit ses séances des prochaines semaines, avec leur pointage, et rien d'autre. Le lien vaut jusqu'à la fin de la saison, il n'est affiché qu'une fois (copie-le et envoie-le-lui), et <strong>« Désactiver »</strong> le ferme à la seconde.</>,
      <>À la création d'un cours ou d'une série, <strong>« Qui donne cette séance ? »</strong> la nomme : le planning public affiche <strong>« avec Léa »</strong>, la visiteuse peut filtrer par prof, l'onglet <strong>« L'équipe »</strong> de ta page présente chacune (prénom, bio, photo, saisis sur sa ligne d'équipe), et une série ajustée plus tard garde son intervenante.</>,
      <>Tu donnes aussi des cours ailleurs, dans une association ou un studio qui n'est pas encore sur IziSolo ? En bas de la page Équipe, <strong>« Ailleurs »</strong> → <strong>« Inviter mon asso ou mon studio »</strong> : tu saisis son nom et <strong>son adresse</strong> (pas la tienne, une structure a son propre compte), elle reçoit un lien, ouvre son espace, et tu y es inscrite comme intervenante sans rien ressaisir. Ça marche aussi depuis Essentiel gratuit.</>,
  ...
  },
  {
    ...
    etapes: [
      <>Tu as <strong>30 jours d\'essai de Complet</strong>, sans carte bancaire, avec toutes les fonctionnalités. Dès le premier jour, ton menu affiche <strong>« Essai Complet · J-x »</strong> et une petite étiquette <strong>« Complet »</strong> sur les fonctions qui s\'éteindront à la fin (messagerie, sondages, cours d\'essai, liste d\'attente). Rien ne se déclenche tout seul à la fin : tu passes sur Essentiel, gratuit, et c\'est toi qui choisis de garder Complet, quand tu veux.</>,
      <><strong>Paramètres</strong> → <strong>Mon abonnement IziSolo</strong> → la carte de la formule qui te va → <strong>« Choisir »</strong>. <strong>Essentiel</strong> est gratuit, sans carte, pour toujours : tout ce que tu gères seule. <strong>Complet</strong> à 29 € par mois ajoute la boucle élève (paiement en ligne, réservation, espace élève, cours en visio) ; tu l'essaies 30 jours, puis tu retombes sur Essentiel si tu ne le gardes pas, sans rien perdre de ce que tu as saisi. Une association ou un studio à plusieurs profs a son plan (Association 39 €, Studio 59 €, ou à l'année avec deux mois offerts).</>,
      ...
      <>Le prélèvement démarre <strong>le jour où tu souscris</strong>, pas à la fin de tes 30 jours : tes jours d\'essai sont déjà comptés par IziSolo, on ne t\'en fait pas payer deux fois. Ensuite, c\'est tous les mois à la même date.</>,
      ...
      <>Sur Essentiel, ton tableau de bord te dit parfois <strong>« ta page publique a été ouverte N fois cette semaine »</strong> : ce sont des visiteuses qui ont regardé ton planning sans pouvoir réserver, puisque la réservation en ligne est dans Complet. On compte les <strong>ouvertures de la page</strong>, jamais les personnes : ni nom, ni adresse IP, ni page visitée, et tes propres visites ne comptent pas. Tu peux masquer la carte, elle revient au plus tôt une semaine après.</>,
    ],

...
const SECTIONS = [
  ...
  },
  {
    ...
    etapes: [
      ...
      <>Travailler à plusieurs fait partie des plans <strong>Association</strong> (39 € par mois, réservé aux associations déclarées avec leur numéro RNA) et <strong>Studio</strong> (59 € par mois) : un seul abonnement pour toute la structure, autant de profs que tu veux, et deux mois offerts à l'année. Si l'abonnement s'arrête, personne n'est effacé : chacune retrouve sa place dès qu'il reprend.</>,
    ],

...
const SECTIONS = [
  ...
  },
  {
    ...
    etapes: [
      ...
      <>Un règlement qui arrive <strong>en plus</strong> de ce qui était prévu (un versement de plus sur un abo au mois, un complément) : carte du carnet → <strong>« Encaisser un versement »</strong>, mode déclaré, date d'encaissement. Si une ligne <strong>attend déjà</strong> sur cet abonnement (« à encaisser »), la modale te le dit et te propose de l'encaisser à la place, en un ou plusieurs moyens : c'est presque toujours ça qu'il faut, sinon l'argent compte deux fois.</>,

...
const SECTIONS = [
  ...
  },
  {
    ...
    etapes: [
      ...
      <>Des élèves anglophones ? Dans <strong>« Ce que ta page montre »</strong>, choisis la <strong>langue</strong> de ta page et de l&apos;espace de tes élèves : Français ou English. En anglais, la page, la réservation, la connexion, l&apos;espace élève et les emails de confirmation et de connexion parlent anglais ; tes textes à toi (bio, noms de cours, FAQ) restent tels que tu les as écrits. Quel que soit ton choix, chaque visiteuse garde un bouton <strong>FR / EN</strong> en haut de ta page pour choisir la sienne.</>,

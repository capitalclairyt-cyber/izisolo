...
const SECTIONS = [
  ...
  },
  {
    ...
    etapes: [
      ...
      <><strong>Paramètres</strong> → <strong>Mon abonnement IziSolo</strong> → la carte de la formule qui te va → <strong>« Choisir »</strong>. Deux formules : <strong>Essentiel</strong> à 15 € par mois, et <strong>Complet</strong> à 29 € par mois, qui ajoute la boucle élève (paiement en ligne, réservation, cours en visio).</>,

...
const SECTIONS = [
  ...
  },
  {
    ...
    etapes: [
      ...
      <>Réglages dans <strong>Paramètres → Ma page publique</strong> : ce qui s'affiche (horaires, tarifs), le cours d'essai (validation manuelle ou automatique), et « Intégrer sur mon site » pour tes couleurs et ton QR code.</>,

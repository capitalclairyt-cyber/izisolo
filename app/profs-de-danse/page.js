...
export const metadata = {
  ...
  description: "Outil de gestion pour les profs de danse : classique, contemporain, hip-hop, swing, salsa. Cycles trimestriels, paiement échelonné, stages week-end, multi-niveaux. Gratuit pour commencer, sans carte bancaire.",
  ...
  openGraph: {
    ...
    url: 'https://www.izisolo.fr/profs-de-danse',
    type: 'website',

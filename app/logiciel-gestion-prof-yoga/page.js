...
export const metadata = {
  ...
  description: "Le logiciel de gestion tout-en-un pour prof de yoga solo : agenda, élèves, présences, paiements, mini-compta et portail de réservation — sur ton téléphone. Gratuit pour commencer, sans carte bancaire.",
...
export default async function LogicielGestionPage() {
  ...
  const appSchema = {
    ...
    offers: {
      ...
      priceCurrency: 'EUR',
      description: "Essentiel gratuit pour toujours, sans carte bancaire ; Complet à 29 €/mois après 30 jours d'essai.",
    },
  };

...
export const metadata = {
  ...
  description: "Une alternative douce à Doctolib pour les sophrologues : RDV public, anamnèse confidentielle, programmes 6-10 séances, reçus PDF conformes (art. 293 B). Gratuit pour commencer, sans carte bancaire.",

...
export const metadata = {
  ...
  description: "Outil de gestion pour les profs de méditation et mindfulness : cycles MBSR, méditations guidées, retraites silencieuses, paiements. Sans création de compte pour tes participant·e·s. Gratuit pour commencer, sans carte bancaire.",
  ...
  openGraph: {
    ...
    url: 'https://www.izisolo.fr/profs-de-meditation',
    type: 'website',

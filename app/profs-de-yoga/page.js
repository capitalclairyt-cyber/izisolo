...
export const metadata = {
  ...
  description: "L'outil calme et beau pour les profs de yoga solo. Agenda, élèves, paiements, portail public — tout-en-un. Gratuit pour commencer, sans carte bancaire.",
  ...
  openGraph: {
    ...
    url: 'https://www.izisolo.fr/profs-de-yoga',
    type: 'website',

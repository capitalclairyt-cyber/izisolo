...
export const CASES = [
  ...
  {
    id: 'sans_adhesion',
    // v113 (lot 3 Assos & Studios) : une association peut exiger l'adhésion
    // pour réserver. Jamais un refus de POINTER : au pointage, la ligne porte
    // seulement un repère « sans adhésion ».
    uniquement: 'association',
    titre: 'Réservation sans adhésion à jour',
    desc: 'Que doit faire l\'app quand une personne réserve un cours alors qu\'elle n\'a pas d\'adhésion à jour pour la saison ?',
    icone: '🪪',
    options: [
      { value: 'accepter', label: 'Accepter la réservation',              subText: 'Elle réserve ; au pointage, sa ligne porte un repère « sans adhésion » pour régulariser sur place.' },
      { value: 'bloquer',  label: 'Bloquer tant qu\'elle n\'a pas adhéré', subText: 'Le message lui dit de prendre son adhésion auprès de l\'association.' },
    ],
    defaut: { mode: 'auto', choix: 'accepter', notifProf: false, notifEleveEmail: false, notifEleveSms: false },
  },
  {

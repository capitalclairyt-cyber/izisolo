...
export async function finaliserDemande(supabase, demande) {
  ...
  if (resa?.ok) {
    ...
    const messages = {
      complet: 'Ce cours est désormais complet.',
      annule: 'Ce cours a été annulé.',
      introuvable: 'Cours introuvable.',
    };
    const err = new Error(messages[resa?.reason] || 'Réservation impossible.');
 ...
 */
export async function emailConfirmationVisiteur({ profileNom, studioSlug, prenom, email, cours, paiement, prix, stripeLink, proEmail = null, adresse = null, codePostal = null, ville = null, telephone = null, magicLink = null }) {
      ...
      html: `
        <div style="font-family:-apple-system,BlinkMacSystemFont,sans-serif;max-width:560px;margin:0 auto;padding:24px;">
          ...
          <div style="text-align:center;margin:0 0 20px;">
            ...
            <p style="color:#999;margin:10px 0 0;font-size:0.75rem;">Ce lien te connecte sans mot de passe (valable 1 heure).</p>
          </div>` : ''}
          ${infosBlock}

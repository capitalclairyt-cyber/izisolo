...
export function enrichirProfil(p, emailById, lastSignInById, usage) {
  ...
  return {
    ...
    compte_statut: statut,               // free | trial_active | trial_expired | subscribed | offert | past_due | canceled
...
export function repartitionStatuts(profilsEnrichis) {
  const rep = { subscribed: 0, offert: 0, trial_active: 0, trial_expired: 0, past_due: 0, canceled: 0, free: 0 };

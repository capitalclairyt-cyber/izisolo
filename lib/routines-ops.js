...
export const ROUTINES_OPS = [
  {
    ...
    // 95 et pas 90 : la routine Claude programmée passe les 21 fév/mai/août/nov
    // (au plus 92 jours d'écart) — la marge évite un badge « en retard » de
    // 2 jours à chaque trimestre alors que le passage automatique arrive.
    frequenceJours: 95,
    derniereExecution: '2026-08-21',
    procedure:
      'Automatique : la routine Claude programmée (claude.ai/code/routines, « Vérif '
      + 'trimestrielle des comparatifs IziSolo ») fait le relevé chaque 21 fév/mai/août/nov '
      + 'et pousse les correctifs. À la main : demander à Claude « lance la vérification '
  ...
  {
    id: 'taux-urssaf',
    nom: 'Vérifier les taux URSSAF de l\'année',
    description:
      'Le taux de cotisations micro (BNC libéral, BIC services, BIC vente), la CFP '
      + 'et le versement libératoire changent d\'une année à l\'autre. Ils sont '
      + 'recopiés dans 7 surfaces publiques (5 articles de blog, content/cities-extra.js, '
      + 'et deux fois en dur dans app/outils/calculateur-revenu-prof-yoga/Calculateur.jsx) '
      + 'plus les défauts proposés dans lib/urssaf.js. Un taux périmé, c\'est une '
      + 'estimation fausse affichée à des profs sur leur argent.',
    // Annuel, calé sur janvier : les nouveaux taux s'appliquent au 1er janvier.
    frequenceJours: 365,
    derniereExecution: null,
    procedure:
      'Relever les taux à la source sur autoentrepreneur.urssaf.fr (rubrique « Le taux '
      + 'de cotisations »), puis : 1) corriger REGIMES dans lib/urssaf.js (défauts '
      + 'PROPOSÉS, la prof saisit les siens) ; 2) grep du taux dans le repo et '
      + 'correction de chaque occurrence publique ; 3) noter la date de relevé dans '
      + 'les articles concernés. Ne JAMAIS écrire un taux de mémoire.',

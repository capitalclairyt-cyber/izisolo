...
/**
 * Pose la langue sur une fiche SEULEMENT si elle n'en a pas encore : c'est le
 * geste du repli navigateur (v123), un signal faible qui ne remplace jamais
 * un choix explicite (cookie) déjà mémorisé.
 */

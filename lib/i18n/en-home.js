...
const EN = {
  ...
  // Le planning au-delà de la fenêtre (2026-09-23) : ▶ et « Voir les semaines suivantes »
  'Chargement de la semaine…': 'Loading this week…',
  'Chargement…': 'Loading…',
  'Impossible de charger cette semaine.': "This week couldn't be loaded.",
  'Impossible de charger ces séances pour le moment.': "These classes couldn't be loaded right now.",
  'Réessayer': 'Try again',
  'Voir les semaines suivantes': 'Show the following weeks',
  "Le planning s'affiche jusqu'à un an à l'avance.": 'The schedule is shown up to one year ahead.',
  "Planning affiché jusqu'au {date}": 'Schedule shown until {date}',

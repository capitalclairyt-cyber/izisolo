 ...
 * @param {string} studioId le studio affiché (useStudioId côté composant) —
 *   passé en paramètre plutôt que redéduit ici : une deuxième résolution du
 *   studio est une deuxième vérité, et deux vérités finissent par diverger.
 * @returns {Promise<string>} message prêt pour un toast
 */
export async function messageErreurClient(err, email, studioId) {

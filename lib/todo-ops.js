...
export const TODO_OPS = [
  ...
  },
  {
    ...
    statut: 'a_faire',
    ajoute: '2026-08-21',
    titre: 'Brancher l\'hôte admin (admin.izisolo.fr)',
    description:
      'Le code est déployé, restent 3 gestes : ajouter le domaine dans Vercel → Domains, '
      + 'poser le CNAME « admin » chez LWS, ajouter https://admin.izisolo.fr/** aux '
      + 'Redirect URLs de Supabase Auth. Puis installer la PWA admin sur les 2 téléphones '
      + 'et activer la double authentification dans /admin/securite.',
  },
  {
    id: 'migration-paris',
    categorie: 'secu',

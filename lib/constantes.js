...
export const PLANS = {
  ...
  pro: {
    ...
    videos: false,           // réservé Premium
    coursMonetisables: false, // réservé Premium
  ...
  premium: {
    ...
    // Bonus Premium réels (les seuls vrais différentiateurs Pro → Premium) :
    videos: true,             // vidéos de cours (uploader + diffuser)
    coursMonetisables: true,  // cours payants à l'unité (a la carte premium)

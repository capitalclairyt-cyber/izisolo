...
//
// Grille tarifaire validée 2026-05-19 :
//   - Prix public : Solo 17€ / Pro 22€ / Studio 79€ mensuel ; -20 % en annuel
//   - Founding 100 (à vie) : Solo 9€ / Pro 19€ / Studio 49€
//   - Early Bird (places 101-300, 6 mois) : Solo 12€ / Pro 24€
...
export const PLANS = {
  free: {
    ...
    prix: 0,
    prixAnnuel: 0,
    // Comptes internes/exemptés : full access comme Studio
    limiteClients: null,
    limiteLieux: null,
    limiteOffres: null,
    portail: true,
    ...
    brandingEmail: true,
    videos: true, // vidéos de cours (uploader + diffuser + vendables à l'unité ou en abonnement)
  ...
  solo: {
    ...
    // Limites
    limiteClients: 40,
    limiteLieux: null, // lieux illimités pour tous (plus un différenciateur, 2026-07-13)
    limiteOffres: 5,
    // Features base
    portail: true,
  ...
  pro: {
    ...
    // Limites (élèves illimités, lieux illimités)
    limiteClients: null,
    limiteLieux: null, // lieux illimités pour tous (plus un différenciateur, 2026-07-13)
    limiteOffres: null,
    ...
    anniversairesAuto: true,
    reglesAnnulationAvancees: true,
    brandingEmail: false, // réservé Studio
    videos: false,        // réservé Studio
    fraisStripeIziSolo: 1, // 1 % en plus des frais Stripe natifs
  },
  premium: {
    nom: 'Studio',
    public: true,
    comingSoon: true, // ⚠️ pas encore prêt — UI grise la carte + désactive le subscribe
    prix: 79,
    prixAnnuel: 758, // 79 × 12 × 0.8 ≈ 758 €
    ...
    // Bonus Studio réel (le seul vrai différentiateur Pro → Studio) :
    videos: true, // vidéos de cours : uploader + diffuser + vendables à l'unité ou en abonnement
    // Frais Stripe IziSolo : 1% comme Pro (le 0% précédent retiré, pas

...
// Fin de couverture du référentiel (à décaler à CHAQUE refresh annuel) :
// au-delà de ces dates, estPendantVacances/estJourFerie renvoient false EN
// SILENCE — les aperçus de génération/prolongation affichent un avertissement
// quand la plage demandée dépasse (audit B1b 2026-07-25).
export const VACANCES_COUVERTURE_MAX = '2027-08-29';
export const FERIES_COUVERTURE_MAX = '2027-12-25';

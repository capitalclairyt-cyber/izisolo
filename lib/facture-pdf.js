...
export async function genererFacturePdf({ type, numeroAffiche, dateEmission, snapshot }) {
  ...
  if (estFacture && emetteur.siret) ligneTexte(`SIRET : ${formaterSiret(emetteur.siret)}`);
  ...
  y = 100;
  page.drawText(mentionTva || 'TVA non applicable, art. 293 B du CGI (auto-entrepreneur ou micro-entreprise).', {

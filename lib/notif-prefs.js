...
export const NOTIF_TYPES_PROF = [
  ...
  { key: 'paiement_retard',   label: 'Paiement en attente',    desc: 'Paiement non réglé depuis plus de 7 jours.',     channels: ['inapp'], defaut: { inapp: true } },
  { key: 'carnet_epuise',     label: 'Carnet presque épuisé',  desc: 'Moins de 2 séances sur un carnet actif.',        channels: ['inapp'], defaut: { inapp: true } },
  { key: 'abonnement_expire', label: 'Abonnement qui expire',  desc: 'Abonnement à échéance sous 14 jours.',           channels: ['inapp'], defaut: { inapp: true } },
